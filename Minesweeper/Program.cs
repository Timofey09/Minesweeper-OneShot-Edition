...
namespace Minesweeper
{
    internal static class Program
    {
        ...
        public static bool NikoRidong = false;
        ...
        public static void CleanUpTempFiles()
        {
            ...
            catch (Exception ex) { MessageBox.Show(Properties.Resources.ErrorMsgBox + ex.Message, "ExitCleanUp: Fatal Error", MessageBoxButtons.OK, MessageBoxIcon.Error); }
        }
